...
===  <em>As a student, I can schedule classes for different semesters, so they're separate.</em>
- <em><tt>1</tt> As a student, I can choose which semester's schedule to modify immediately after login, so the context is clear.</em>
- <em><tt>2</tt> As a student, I can change which semester I am working with, so I can accomplish all my goals with one login.</em>
...
- <em><tt>1</tt> As a student, I can type part of a course code or title and see the matching classes, so I can find classes that I want.</em>
...
- <em><tt>2</tt> As a student, courses that I search for appear in list form where each item can be expanded in-page to show details, so I can get information without leaving the page.</em>
...
- <em><tt>1</tt> As a student, I have dummy degree requirements, so I can quickly see how usable the interface is.</em>
